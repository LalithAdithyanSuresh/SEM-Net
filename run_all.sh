...
# 3. Ensure PyTorch 2.1.2 (required for mamba-ssm 1.1.3 & CUDA 12)
...
# 4. Check and Install Core Dependencies & PyTorch Boxing Patch
python -c "
import os, glob
...
# 5. Check & Compile causal-conv1d & mamba-ssm
...
# 6. Check & Compile DCNv3 (ops_dcnv3)
...
echo "[*] Launching Multi-GPU Training (torchrun, 2 GPUs)..."
echo "================================================="
